export const en = {
  ...
  summary: {
    description: [
      "Hello, my name is Jonathan, and I am a Full Stack web developer from Posadas, Misiones, Argentina. I recently completed a 800+ hour programming bootcamp, and am currently expanding my technical skills through a systems analysis associate's degree.",
      "Previously, I studied Economic Sciences, specifically the career of Public Accountant, and I worked in the e-commerce of a leading company in electrical products and lighting. In that position, I was responsible for maintaining the website and uploading all the products they sold, which allowed me to gain valuable customer service and business skills.",
      "Currently, I am looking for an innovative company where I can combine my programming skills with my previous experience to develop myself in junior level positions in Frontend or Backend. I am very excited about the opportunities that they can offer me and I am sure that I will be able to add value to any project in which I participate.",
    ],
